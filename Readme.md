...
**Note: This is only built for PC \& Laptop and not Mobile Devices**



1. Open the link I sent you: https://github.com/ninjaizauwsum/binusmaya-prototype-test
2. In the GitHub page, open the deployment page and open the link with this URL: https://ninjaizauwsum.github.io/binusmaya-prototype-test/ Or, you can simply go to the URL directly
3. In the UI prototype, I want you to try to perform these following tasks:

   * Access a course
   * Find a session and check attendance
